...
class NewsViewController: BaseViewController {
    ...
    func setNewsServiceList(){
        newsServiceList.append(contentsOf: [
            NewsListDataModel(imageName: "news1", title: "아인플라워 오픈 행사", address: "한남동", detail: "안녕하세요 당근님들~~~"),
            NewsListDataModel(imageName: "news2", title: "인테리어 상담 서비스", address: "한남동", detail: "<<여름맞이 인테리어 어쩌구>> 이게 맞나..ㅎ ㅏ......")
        ])
    }
